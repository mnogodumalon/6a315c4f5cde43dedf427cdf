...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Gesundheitsregion Veranstaltungsportal",
    "apps": {
      "veranstaltungen": {
        "name": "Veranstaltungen",
        "app_id": "6a315b225049324bae74cc15",
        "fields": {
          "veranstalter": "Veranstalter (E-Mail-Adresse)",
          "titel": "Titel der Veranstaltung",
          "beschreibung_veranstaltung": "Beschreibung",
          "kategorie": "Kategorie",
          "beginn": "Beginn (Datum & Uhrzeit)",
          "ende": "Ende (Datum & Uhrzeit)",
          "anmeldefrist": "Anmeldefrist",
          "veranstaltungsort_name": "Name des Veranstaltungsorts",
          "veranstaltungsort_strasse": "Straße",
          "veranstaltungsort_hausnummer": "Hausnummer",
          "veranstaltungsort_plz": "Postleitzahl",
          "veranstaltungsort_ort": "Ort",
          "veranstaltungsort_geo": "Standort auf der Karte",
          "max_teilnehmer": "Maximale Teilnehmerzahl",
          "kosten": "Kosten / Eintritt",
          "flyer": "Bild / Flyer"
        },
        "lookups": {
          "kategorie": {
            "gesundheit": "Gesundheit & Prävention",
            "sport": "Sport & Bewegung",
            "ernaehrung": "Ernährung",
            "entspannung": "Entspannung & Achtsamkeit",
      ...
      "veranstalter": {
        "name": "Veranstalter",
        "app_id": "6a315b1e3b0ba0a7a2d28905",
        "fields": {
          "organisation_name": "Name der Organisation",
          "organisation_typ": "Typ der Organisation",
      ...
      "anmeldungen": {
        "name": "Anmeldungen",
        "app_id": "6a315b23fe1f8743a7f9aaff",
        "fields": {
  ...
  "en": {
    "appgroup": "Health Region Event Portal",
    "apps": {
      "veranstaltungen": {
        "name": "Events",
        "app_id": "6a315b225049324bae74cc15",
        "fields": {
          ...
          "kategorie": "Category",
          "beginn": "Start (Date & Time)",
          "ende": "End (Date & Time)",
          "anmeldefrist": "Registration Deadline",
          "veranstaltungsort_name": "Venue Name",
          "veranstaltungsort_strasse": "Street",
          "veranstaltungsort_hausnummer": "House Number",
          "veranstaltungsort_plz": "Postal Code",
      ...
      "veranstalter": {
        ...
        "fields": {
          ...
          "ort": "City",
          "website": "Website",
          "beschreibung": "Organization Description"
        },
        "lookups": {
          "organisation_typ": {
            "verein": "Club",
