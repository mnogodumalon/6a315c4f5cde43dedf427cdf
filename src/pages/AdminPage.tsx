...
const VERANSTALTUNGEN_FIELDS = [
  ...
  { key: 'beschreibung_veranstaltung', label: 'Beschreibung', type: 'string/textarea' },
  { key: 'kategorie', label: 'Kategorie', type: 'lookup/select', options: [{ key: 'gesundheit', label: 'Gesundheit & Prävention' }, { key: 'sport', label: 'Sport & Bewegung' }, { key: 'ernaehrung', label: 'Ernährung' }, { key: 'entspannung', label: 'Entspannung & Achtsamkeit' }, { key: 'beratung', label: 'Beratung & Information' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'beginn', label: 'Beginn (Datum & Uhrzeit)', type: 'date/datetimeminute' },
  { key: 'ende', label: 'Ende (Datum & Uhrzeit)', type: 'date/datetimeminute' },
  { key: 'anmeldefrist', label: 'Anmeldefrist', type: 'date/date' },
  { key: 'veranstaltungsort_name', label: 'Name des Veranstaltungsorts', type: 'string/text' },
  { key: 'veranstaltungsort_strasse', label: 'Straße', type: 'string/text' },
  { key: 'veranstaltungsort_hausnummer', label: 'Hausnummer', type: 'string/text' },
  { key: 'veranstaltungsort_plz', label: 'Postleitzahl', type: 'string/text' },
  { key: 'veranstaltungsort_ort', label: 'Ort', type: 'string/text' },
  { key: 'veranstaltungsort_geo', label: 'Standort auf der Karte', type: 'geo' },
...
export default function AdminPage() {
  ...
  const getLookupLists = useCallback((entity: EntityKey) => {
    ...
    switch (entity) {
      case 'veranstaltungen':
        lists.veranstalterList = (data as any).veranstalter ?? [];
        break;
      case 'anmeldungen':
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'veranstaltungen' && fieldKey === 'veranstalter') {
      const match = (lists.veranstalterList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.organisation_name ?? '—';
    }
    if (entity === 'anmeldungen' && fieldKey === 'veranstaltung') {
